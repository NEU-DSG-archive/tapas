...
//ADDED to change default show more behavior to popup
//          $(this).prev().find('li:gt(' + limit + ')').slideDown();
//          $(this).addClass('open').text(Drupal.t('Show fewer'));
var $ctitle = $(this).closest($('.block-content')).prevAll('h2').html();
//var $addclass = $(this).prev().find('li').addClass('list-all-items');
var $ccontent = $(this).prevAll('ul').html();
var $cbox = '<h2>'+$ctitle+'</h2><ul>'+$ccontent+'</ul>';
$.colorbox({open:true, html: $cbox, width: '80%', height: '50%', top: '50%', left:'10%', opacity: 0, reposition:true, fixed:true, onClosed:function(){
//$addclass.removeClass('list-all-items');     
    }});
        }
        else {
