...
sub vcl_recv {
  ...
  //  * you should let through the cache_render cookie.
  //  *
  //  * More information on:
...
sub vcl_deliver {
  ...
  // /*
  //  * Support for authcache_debug widget
  //  * Only set cookie indicating a hit when:
  //  * 1. There was at least one cache hit for the content being delivered
  //  * 2. The cache_render was set to "get" from within authcache-debug.js
  //  * 3. The page was actually generated by Drupal.
  //  */
  ...
  // /**
  //  * Example 1: Add a hit-miss header to the response.
  //  *
  //  * See:
