...
//ADDED this is modified
  protected function defaultSorts() {
    return array(
      'score' => array('title' => t('Relevancy'), 'default' => 'desc'),
//      'sort_label' => array('title' => t('Title'), 'default' => 'asc'),
      'sort_field_title' => array('title' => t('Title'), 'default' => 'asc'),
      'bundle' => array('title' => t('Type'), 'default' => 'asc'),
//      'sort_name' => array('title' => t('Author'), 'default' => 'asc'),sort_name_formatted
      'sort_name_lf_formatted' => array('title' => t('TAPAS Contributor'), 'default' => 'asc'),
      'ds_created' => array('title' => t('Publication Date (TAPAS)'), 'default' => 'desc'),
//ADDED for additional sorts...this should be moved to a hook. sorry
      'ds_changed' => array('title' => t('Modification Date (TAPAS)'), 'default' => 'desc'),
      'sort_field_dc_creator' => array('title' => t('Author'), 'default' => 'asc'),
      'ds_field_dc_date' => array('title' => t('Publication Date of Source'), 'default' => 'desc'),
      'dds_field_dc_coverage_temporal_start' => array('title' => t('Time Period Start'), 'default' => 'desc'),
      'dds_field_dc_coverage_temporal_end' => array('title' => t('Time Period End'), 'default' => 'desc'),
    );
  }
//END
  /**
