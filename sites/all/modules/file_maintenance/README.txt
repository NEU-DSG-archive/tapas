...
Overview
--------
File manager is a tool (for Drupal 7) to administer managed and 
...
Usage
-----
File manager provides a file browser UI with a directory tree and a file 
...
Development Status
------------------
File manager is being developed for Drupal 7. It is still work in 
