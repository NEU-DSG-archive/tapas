...
<div id="timelinemap-all-<?php print $div_id; ?>" class="timelinemap-all">
  <div class="timelinecontainer"
       style="width: <?php print $options['timelinemap']['width'];?>; height: <?php print $options['timelinemap']['tlheight'];?>">
    <div id="timeline-<?php print $div_id; ?>" class="timeline"></div>
  </div>
  <div class="mapcontainer"
       style="width: <?php print $options['timelinemap']['width'];?>; height: <?php print $options['timelinemap']['mheight'];?>">
...
if (user_access('embed timeline map') && $options['embed_link'] && ($meassurement_m == $meassurement_tl)):
  ?>
<div id="timelinemap-embed-wrapper-<?php print $div_id; ?>" style="text-align:right;font-size:80%;">
  <a id="timelinemap-<?php print $div_id; ?>-embed" class="timelinemap-embed-link" overwrite=""
     rel="timelinemap-all-<?php print $div_id; ?>" attrwidth="<?php print $options['timelinemap']['width']; ?>"
     attrheight="<?php print $height . $meassurement_m; ?>" href="javascript: void(0);">[embed]</a></div>
<?php
  endif;
?>